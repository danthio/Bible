...
im=Image.open("data/left.png")
im=im.resize((30,30))
im.save("data/left.png")

im=Image.open("data/right.png")
im=im.resize((30,30))
im.save("data/right.png")
...
def view_highlights():
	...
	can.create_text(wd/2,35/2,text="Highlights",font=("FreeMono",20),fill="#000000")

	draw_round_rec(can,4,45-10, 4+frame["width"]+1,45+frame["height"]+10,10,"#aaaaaa","",1)
	...
	if len(ar)==0:
		can2.create_text(wd/2,(ht-90)/2, text="No Record!",font=("FreeMono",30),fill="#555555")
...
def main(book_,chapter_,verse_):
	global state,can,can2,frame,back2
	global wd,ht
	...
	can.create_image(x-15,ht-(35)/2-15,image=previous,anchor="nw")

	can.create_image(wd-x-15,ht-(35)/2-15,image=next_ ,anchor="nw")




	draw_round_rec(can,4,45-10, 4+frame["width"]+1,45+frame["height"]+10,10,"#000000","",1)



	title=str(bible_books[book_-1])+"  "+str(chapter_)

	can.create_text(wd/2,(45-10)/2,text=title,font=("FreeMono",20),fill="#000000")
...
def select_chapter_and_verse(c):
	...
	if c==0:
		can.create_text(wd/2,y-50,text="Old Testament",font=("FreeMono",13),fill="#000000")
	elif c==1:
		can.create_text(wd/2,y-50,text="New Testament",font=("FreeMono",13),fill="#000000")

	can.create_arc(xx,y-10-20, xx+30,y-10-20+30,start=90,extent=90,style="arc",outline="#000000")
	can.create_arc(xx,y+167-20-30, xx+30,y+167-20,start=180,extent=90,style="arc",outline="#000000")


	can.create_arc(xx+520-30,y-10-20, xx+520,y-10-20+30,start=0,extent=90,style="arc",outline="#000000")
	can.create_arc(xx+520-30,y+167-20-30, xx+520,y+167-20,start=270,extent=90,style="arc",outline="#000000")

	can.create_line(xx+15,y-10-20, xx+520-15,y-10-20,fill="#000000")
	can.create_line(xx+15-1,y+167-20, xx+520-15,y+167-20,fill="#000000")

	can.create_line(xx,y-10-20+15, xx,y+167-20-15,fill="#000000")
	can.create_line(xx+520,y-10-20+15, xx+520,y+167-20-15,fill="#000000")


	can.create_text(xx+30,y,text="Book",font=("FreeMono",13),fill="#000000",anchor="w")
	...
	combo1.place(in_=root,x=xx+30,y=y+20)


	can.create_text(xx+30,y+70,text="Chapter",font=("FreeMono",13),fill="#000000",anchor="w")


	combo2['values'] = ar_var2
	combo2['state'] = 'readonly'
	combo2.place(in_=root,x=xx+30,y=y+20+70)



	can.create_text(xx+30+243,y+70,text="Verse",font=("FreeMono",13),fill="#000000",anchor="w")

	combo3['values'] = ar_var3
	combo3['state'] = 'readonly'

	combo3.place(in_=root,x=xx+30+243,y=y+20+70)
...
can=tk.Canvas(width=wd,height=ht,relief="flat",highlightthickness=0,border=0,bg="#ffffff")
...
frame=tk.Frame(bg="#ffffff",width=wd-10,height=ht-90)

can2=tk.Canvas(frame,bg="#ffffff",width=wd-10-7,height=ht-90,relief="flat",highlightthickness=0,border=0,
	scrollregion=(0,0,wd-10-7,ht-90))
